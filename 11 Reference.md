...
Certbot. (n.d.). *Certbot instructions: Nginx on Linux snap*. Electronic Frontier Foundation.
https://certbot.eff.org/instructions?ws=nginx&os=snap

Let's Encrypt. (n.d.). *Getting started*.
https://letsencrypt.org/getting-started/

Let's Encrypt. (n.d.). *Documentation*.
https://letsencrypt.org/docs/

NGINX. (n.d.). *Beginner's guide*.
